...
require "kitchen/provisioner/dokken_encrypt_databags"

RSpec.describe(Kitchen::Provisioner::EncryptDatabags) do
  shared_examples "an encrypting data bags provisioner" do
  ...
  describe(Kitchen::Provisioner::ChefZeroEncryptDatabags) do
    it_behaves_like "an encrypting data bags provisioner"
  end

  describe(Kitchen::Provisioner::DokkenEncryptDatabags) do
    it_behaves_like "an encrypting data bags provisioner"
  end
end
